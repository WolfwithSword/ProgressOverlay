...
Modified from base to support custom colours and modified styles
*/
! function(r) {
    function t(r) {
    ...
    r.fn.circularloader = function(t) {
        ...
        if (0 == r("#" + o + "canvas").length) {
            var n = r.extend({
                ...
                p = "color:" + n.fontColor + ";font-size:" + parseInt(n.fontSize) 
							+ "px;width:" + 2 * (i + l) 
							+ "px;vertical-align:middle;position:relative;"
							...
							+"-ms-transform: translateY(-48%);height:" + 2 * (i + l) + "px;"
							+"margin-left:-" + 2 * (i + l) + "px;text-align:center;padding:0;"
							+ (n.showText ? "" : "display:none;");

            r('<canvas style="filter:blur(1px); -webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;" data-width="' + l + '" data-radius="' + i 
							+ '" data-stroke="' + n.progressBarColor 
							+ '" data-progressBarBackground="' 
							+ n.progressBarBackground 
							+ '" data-backgroundColor="' + n.backgroundColor 
							+ '" data-text=' + n.showText + " data-percent=" 
							+ (void 0 == t.progressValue ? !0 : !1) 
							+ ' id="' + o + 'canvas" width=' + 2 * (i + l) 
							+ " height=" + 2 * (i + l) + "></canvas>").appendTo(s),
								r('<input class="clProg" style="' + p + '" value="' 
									+ d + (void 0 == t.progressValue ? "%" : "") + '"></input>').appendTo(s),
									"" == n.title ? r("#" + o).css("height", 2 * (i + l)) : (r("#" + o).css("height", 2 * (i + l) + 20),
								r("#" + o + "canvas").before("<div class='titleCircularLoader' style='height:19px;text-align:right;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;'>" 
								+ n.title + "</div>"), r(".titleCircularLoader").css("width", 2 * (i + l))); {
                var g = r("#" + o + "canvas")[0],
                    h = g.getContext("2d"),
                    u = g.width / 2,
                    f = g.height / 2;
            ...
            var c = 0,
                d = 0;
            c = void 0 == t.progressPercent ? parseInt(t.progressValue) > 100 ? 100 : parseInt(t.progressValue) : parseInt(t.progressPercent) > 100 ? 100 : parseInt(t.progressPercent), d = void 0 == t.progressValue ? parseInt(t.progressPercent) > 100 ? 100 : parseInt(t.progressPercent) : parseInt(t.progressValue), e(c, d, o)
        }
        return this
    }
}(jQuery);